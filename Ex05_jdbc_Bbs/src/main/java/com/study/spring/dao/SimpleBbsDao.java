...
public class SimpleBbsDao implements ISimpleBbsDao {
	...
	/*
	 * @Override public List<SimpleBbsDto> listDao(int page, int size) {
	 * System.out.println("--------------- listDao 실행 ---------------");
	 * 
	 * int offset = (page -1)*size;
	 * 
	 * String query =
	 * "select * from simple_report order by id desc limit ? offset ?";
	 * 
	 * List<SimpleBbsDao> list = template.query( query, new
	 * BeanPropertyRowMapper<>(SimpleBbsDto.class), size, offset );
	 * 
	 * 
	 * return list;
	 * 
	...
	public int deleteDao(String id) {
		...
		String query = "delete from simple_report where id = ? ";
